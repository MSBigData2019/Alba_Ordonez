...
Comme vous avez déjà les données nécessaires à l'exécution du code, je n'ai pas jugé utile de les inclure dans ce répertoire.
Afin que le code puisse tourner, veuillez prendre en compte qu'il faudra changer le path des données à traiter dans la partie du code: ** 1. Charger le dataframe: prepared_trainingset (parquet) **/. 
